        ...
        <div class="col-md-6">
            ...
            <div class="card">
                ...
                <div class="card-block">
                    ...
                    <button type="button" class="btn btn-secondary"><i class="fa fa-lightbulb-o"></i>&nbsp; Secondary
                    </button>
        ...
        <div class="col-md-6">
            ...
            <div class="card">
                ...
                <div class="card-block">
                    ...
                    <button type="button" class="btn btn-outline-warning"><i class="fa fa-map-marker"></i>&nbsp; Warning
                    </button>
